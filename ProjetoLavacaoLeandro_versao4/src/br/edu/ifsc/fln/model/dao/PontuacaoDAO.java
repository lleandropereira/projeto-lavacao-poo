...
public class PontuacaoDAO {
    ...
    public void inserir(Pontuacao pontuacao) throws DAOException {
       ...
       String sql = "INSERT INTO pontuacao(id_cliente) VALUES(?)";
        try {
            ...
            throw new DAOException("Não foi possível inserir a pontuação no banco de dados!", ex);
        }
    }
    ...
    public void alterar(Pontuacao pontuacao) throws DAOException {
        ...
        try {
            ...
            Logger.getLogger(PontuacaoDAO.class.getName()).log(Level.SEVERE, null, ex);
            throw new DAOException("NNão foi possível alterar a pontuação no banco de dados!", ex);
        }
    }
    ...
    public void remover(Pontuacao pontuacao) throws DAOException {
        ...
        try {
            ...
            Logger.getLogger(PontuacaoDAO.class.getName()).log(Level.SEVERE, null, ex);
            throw new DAOException("Não foi possível remover a pontuação no banco de dados!", ex);
        }
    }
    ...
    public List<Pontuacao> listar() throws DAOException {
        ...
        try {
            ...
            throw new DAOException("Não foi possível listar a pontuação no banco de dados!", ex);
        }
        return retorno;
    }
    ...
    public int buscarQuantidade(Pontuacao pontuacao) throws DAOException {
        ...
        try {
            ...
            throw new DAOException("Não foi possível buscar a pontuação no banco de dados!", ex);
        }
